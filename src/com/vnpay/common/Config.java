...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/WebPaymentTesting/vnpay_return.jsp";
    public static String vnp_TmnCode = "1VH8Q06Q";
    public static String vnp_HashSecret = "MDEEBGHQDTRPAFEHEKILJJIHLBNERNKS";
